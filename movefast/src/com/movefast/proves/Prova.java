...
public class Prova {
    ...
    public static void main(String[] args) {
        ...
        Vehicle vehicle1 = new Vehicle("7458-QWE", 105.5, "B");
        Vehicle vehicle2 = new Vehicle("1558-TKR", 105.5, "B");
        ...
        Vehicle vehicle3 = new Vehicle("6723-YHU", 78.7, "B");
        c.altaClient(ayoub);
        c.altaClient(emilio);
        ...
        EmpresaLeasing empresaLea = new EmpresaLeasing("empresaleasing", "carrer prova", 666666666, "Contacte");
        Leasing leasing = new Leasing(120, "46391111l", "Leasing", "prova", 601226553, "contaBanc5874");
      ...
      for(Vehicle disponible: mostrarVehiclesDisponibles){
        ...
        c.crearEmpresaLeasing(empresaLea);
        System.out.println(c.consultaLloguerEmpresa(empresaLea));
